...
jQuery(document).ready(function(){
    jQuery('.multi-select-sortable-container').each(function(key, value){ 
        ...
        jQuery('body').bind('neutron.form.beforeSend', function(){
            jQuery('#multi-select-sortable-error-' + options.id).hide();
        });
    
        jQuery('#neutron-multi-select-sortable-error-cancel-' + options.id).click(function(){
        ...
        jQuery('.multi-select-element .delete-btn').live('click', function(){
            jQuery('#multi-select-sortable-error-' + options.id).hide();
