...
class Select2DependentType extends AbstractType
{
    ...
    {
        $builder
            ->add($options['first_name'], 'neutron_select2_' . $options['widget'], $options['first_options'])
            ->add($options['second_name'], 'neutron_select2_' . $options['widget'], $options['second_options'])
        ;   
    }
    ...
    {
        return 'neutron_select2_dependent';
    }
