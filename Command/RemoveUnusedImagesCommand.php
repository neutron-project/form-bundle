 ...
 * @since 1.0
 */
class RemoveUnusedImagesCommand extends ContainerAwareCommand
{
    /**
     * (non-PHPdoc)
    ...
    {
        $this
            ->setName('neutron:form:remove-unused-images')
            ->setDescription('Remove unused images in temporary directory')
