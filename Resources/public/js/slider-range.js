...
jQuery(document).ready(function(){
    ...
    jQuery('.neutron-slider-range').each(function(key, value){
        ...
        var label = jQuery('#neutron-slider-range-tpl-' + options.id);
        ...
        jQuery('#neutron-slider-range-' + options.id).slider(options);
